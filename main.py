...
Original file is located at
    https://colab.research.google.com/drive/1l2AIN4arS_V9E6j2FgsetT2vu9x36Dce
...
print("Hello,", name +" " +surname +" " +"who is" +" "+ age +" "+ "old")
...
if operation == "+":
  ...
  result= "0 cannot be divided with any number"
elif operation == "/":
    result = num1 / num2
